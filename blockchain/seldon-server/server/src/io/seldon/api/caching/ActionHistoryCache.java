...
public class ActionHistoryCache implements NewClientListener {
	...
	public List<Long> DgetRecentActions(String clientName,long userId,int numActions)
	{
	...
	public List<Action> DgetRecentFullActions(String clientName,long userId,int numActions)
	{
